...
def GCN(inputs, classes=1):
    ...
    res_2 = base_model.get_layer('conv2_block3_1_relu').output         # 4x >> conv2_block3_1_relu
    res_3 = base_model.get_layer('conv3_block4_1_relu').output         # 8x >> conv3_block4_1_relu 
    res_4 = base_model.get_layer('conv4_block6_1_relu').output         # 16x >> conv4_block6_1_relu
    res_5 = base_model.get_layer('post_relu').output                   # 32x >> post_relu
...
def main():
    ...
    model = GCN(inputs=(512,512,3), classes=4)
    model.summary()
