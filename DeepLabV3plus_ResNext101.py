...
def ASPP(image_features):
  ...
  y_6 = Conv2D(filters=32, kernel_size=3, padding='same', dilation_rate = 2,use_bias=False)(image_features)
  y_6 = BatchNormalization(name=f'bn_3')(y_6)
  y_6 = Activation('relu', name=f'relu_3')(y_6)

  y_12 = Conv2D(filters=32, kernel_size=1, padding='same', dilation_rate = 4,use_bias=False)(image_features)
...
def main():
    ...
    model = DeepLabV3Plus(inputs=(256,256,3), classes=1777)
    model.summary()
    model.save('test.h5')
